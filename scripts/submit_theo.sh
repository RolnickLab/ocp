...
# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=untrained_cano --cano_args.cano_type=3D --cano_args.cano_method=simple --inference_time_loops=0
# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=untrained_cano --cano_args.cano_type=3D --cano_args.cano_method=pointnet --inference_time_loops=0
# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=untrained_cano --cano_args.cano_type=3D --cano_args.cano_method=dgcnn --inference_time_loops=0
# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=fa --cano_args.cano_type=3D --inference_time_loops=0 --continue_from_dir="/network/scratch/t/theo.saulus/ocp/runs/4757146"

# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=trained_cano --cano_args.cano_type=3D --cano_args.cano_method=simple --inference_time_loops=0
# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=trained_cano --cano_args.cano_type=3D --cano_args.cano_method=pointnet --inference_time_loops=0
# python main.py --test_ri=True --mode=train --wandb_tags=faenet++ --wandb_project=faenet++ --config=faenet-qm7x-all --note="Test Trained Canonicalisation QM7x" --cano_args.equivariance_module=trained_cano --cano_args.cano_type=3D --cano_args.cano_method=dgcnn --inference_time_loops=0
