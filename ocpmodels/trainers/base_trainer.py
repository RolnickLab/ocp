...
class BaseTrainer(ABC):
    def __init__(self, **kwargs):
        ...
        transform_models = ["depfaenet", "depschnet", "depgemnet_oc", "depgemnet_t"]
        ...
        self.separate_models = ["indfaenet", "indschnet", "indgemnet_oc", "indgemnet_t"]
        self.heterogeneous_models = ["afaenet", "aschnet", "agemnet_oc", "agemnet_t"]
